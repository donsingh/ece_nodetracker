<?php
	...
	$aircon = array(8,28,49,52,53,54,1,10,19,20);
	$lights = array(27,18,2,4,7,36,32);
	$outlet = array(12,15,26,50,51,3,6,22,13);
	$label = array();
	$power = array();
	...
	$sql = "SELECT * , sum( actp ) , DATE_FORMAT( time, '%H' ) AS division FROM `single_phase` WHERE date='".$today."' AND node IN (".implode(',', $aircon).") GROUP BY division";
